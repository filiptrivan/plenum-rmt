    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VotingTheme", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VotingThemeId = table.Column<long>(type: "bigint", nullable: false),
                    Version = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_VotingThemeItem", x => x.Id);
                    table.ForeignKey(
                        name: "FK_VotingThemeItem_VotingTheme_VotingThemeId",
                        column: x => x.VotingThemeId,
                        principalTable: "VotingTheme",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                name: "UserVotingThemeItem",
                columns: table => new
                {
                    UserId = table.Column<long>(type: "bigint", nullable: false),
                    VotingThemeItemId = table.Column<long>(type: "bigint", nullable: false),
                    VoteTypeId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserVotingThemeItem", x => new { x.UserId, x.VotingThemeItemId });
                    table.ForeignKey(
                        name: "FK_UserVotingThemeItem_User_UserId",
                        column: x => x.UserId,
                        principalTable: "User",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserVotingThemeItem_VoteType_VoteTypeId",
                        column: x => x.VoteTypeId,
                        principalTable: "VoteType",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_UserVotingThemeItem_VotingThemeItem_VotingThemeItemId",
                        column: x => x.VotingThemeItemId,
                        principalTable: "VotingThemeItem",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserVotingThemeItem_VoteTypeId",
                table: "UserVotingThemeItem",
                column: "VoteTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_UserVotingThemeItem_VotingThemeItemId",
                table: "UserVotingThemeItem",
                column: "VotingThemeItemId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VotingThemeItem_VotingThemeId",
                table: "VotingThemeItem",
                column: "VotingThemeId");
        }
